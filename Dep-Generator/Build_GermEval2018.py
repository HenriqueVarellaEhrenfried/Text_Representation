...
DATASET_ORIGIN = [
    "../Datasets/GermEval2018/Parsed_ALL/Fine/",
    "../Datasets/GermEval2018/Parsed_ALL/Coarse/"
]

DATASET_OUTPUT_DEFAULT = "../Datasets/GermEval2018/"
...
for repr in REPRESENTATION.keys():
    for dat_origin in DATASET_ORIGIN:
        ...
        command += " %s -o %s%s-%s-%s-TAG-None -n %s-%s -s Train -d 300 -c 20 -l de -g %s -t none;" % (dat_origin, DATASET_OUTPUT_DEFAULT, BASE_NAME, task, repr, BASE_NAME, task, mode)
